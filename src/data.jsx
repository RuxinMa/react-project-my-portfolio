...
export const skills = [
  ...
  },
  {
    ...
    icon: <FaProjectDiagram className='h-16 w-16 text-fuchsia-700' />,
  ...
  },
  {
    ...
    icon: <FaMobile className='h-16 w-16 text-fuchsia-700' />,
  ...
  },
  {
    ...
    icon: <FaLaptop className='h-16 w-16 text-fuchsia-700' />,
